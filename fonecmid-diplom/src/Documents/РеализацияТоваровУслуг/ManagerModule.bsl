...
Функция ПечатьАкта(МассивОбъектов, ОбъектыПечати)
	...
	Пока Выборка.Следующий() Цикл
		...
		Шапка.Параметры.Номер = Прав(Выборка.Номер,4);
		...
		Подвал.Параметры.СуммаДокумента = СтрШаблон("%1 (%2)", Выборка.СуммаДокумента, ЧислоПрописью( Выборка.СуммаДокумента ,"рубль, рубля, рублей, м, копейка, копейки, копеек, ж"));
